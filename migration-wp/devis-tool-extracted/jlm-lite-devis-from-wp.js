/*
 * JLM Lite Devis — version extraite du WordPress de production
 * Source : https://labienveillance.fr/?page_id=2016 (widget Elementor html.default — id 55d6b59)
 * Date d'extraction : 2026-05-08
 *
 * Différences avec la version /js/jlm-lite-devis.js du repo (25/03/2026, 870 lignes) :
 *  - ADMIN_CODE rallongé : "Loli424720" (vs "424720")
 *  - Système de commentaires/conseils ouvrable en modale (.commentToggle, .commentModalOverlay)
 *  - Modale Conseils (renderCommentModal, openCommentModal, closeCommentModal)
 *  - Bouton "✦ Conseils" sur chaque étape si cfg.comments[step] est rempli
 *  - Échappement Esc pour fermer la modale conseils ET le back-office
 *  - Légères variations CSS (font-family Arial, palette identique)
 *
 * Côté WordPress, ce script est intégré INLINE dans la page Elementor (widget HTML),
 * pas chargé comme asset séparé. Le back-office persiste via deux endpoints AJAX
 * exposés par un plugin custom (non présent dans wp-theme/labienveillance/) :
 *   GET  /wp-admin/admin-ajax.php?action=jlm_get_config
 *   POST /wp-admin/admin-ajax.php?action=jlm_save_config   (admin authentifié uniquement, on suppose)
 */
(function () {
